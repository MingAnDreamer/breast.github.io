...
import { Send, Sparkles, User, ArrowLeft, Lightbulb, MessageSquare, Clock, Calendar, Stethoscope, FileText, Phone, ChevronRight, History, Trash2, Bookmark, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="ai-page">
      ...
      <div className="ai-header">
        <Link to="/consult" className="back-btn">
          <ArrowLeft size={20} />
        </Link>
